...
city_id= "Southampton" # Search for your city ID here: http://bulk.openweathermap.org/sample/city.list.json.g
...
print (sum_w.format(conditions[0].upper() + conditions[1:].lower(), int(round(temperature)), temperature_unit))