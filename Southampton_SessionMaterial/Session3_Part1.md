...
![Heatmap of the Data](../01-numpy_74_0.png)
...
![Average Inflammation Over Time](../01-numpy_76_0.png)
...
![Maximum Value Along The First Axis](../01-numpy_78_1.png)
...
![Minimum Value Along The First Axis](../01-numpy_78_3.png)
...
It's very common to create an alias for a library when importing it in order to reduce the amount of typing we have to do.
...
![The Previous Plots as Subplots](../01-numpy_83_0.png)
...
~~~{.output}
['Python_Basics_Session1.html', 'Python_Basics_Session1_Control.html', 'Session2_Part1.html', 'Session2_Part2.html']
~~~
...
![Analysis of inflammation-01.csv](../03-loop_49_1.png)

~~~ {.output}
inflammation-02.csv
~~~

![Analysis of inflammation-02.csv](../03-loop_49_3.png)\
...
![Analysis of inflammation-03.csv](../03-loop_49_5.png)\
